...
import { a, button, div, footer, h1, header, input, li, section, span, strong, ul, label } from '@cycle/dom'
...
function renderFooter (state) {
  ...
  return footer('.footer', { style: footerStyle }, [
    ...
    (amountCompleted > 0 ? button('.clear-completed', 'Clear completed (' + amountCompleted + ')') : null)
  ])
}
